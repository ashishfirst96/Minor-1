...
void team_mentor()
{
	...
	delay(500);
	setcolor(WHITE);
	outtextxy(160,130,"Vishal Kaushik, Assistant Professor (Proctor)");
	outtextxy(160,220,"Ashish Kumar");
	outtextxy(160,240,"Deepanshu Babbar");
	outtextxy(160,260,"Shivam Singhal");
	outtextxy(160,280,"Shivam Gupta");
